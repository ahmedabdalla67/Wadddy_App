...
import 'package:first_app/modules/waddy_app/search/search_page.dart';
          ...
          child: Column(
            children: [
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            IconButton(icon: const Icon(Icons.note_add),
                            iconSize: 50.0,
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            IconButton(icon: const Icon(Icons.check_box),
                              iconSize: 50.0,
                              color: Colors.redAccent,
                              onPressed: (){
                                navigateTo(context, const NotificationScreen());
              ...
              Row(
                children: [
                  Padding(
                    padding: const EdgeInsetsDirectional.symmetric(vertical: 40.0),
                    child: InkWell(
                      onTap: (){
                        navigateTo(context, const NotificationScreen());
                      },
                      child: Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            IconButton(icon: const Icon(Icons.delivery_dining_outlined),
                              iconSize: 50.0,
                              color: Colors.redAccent,
                              onPressed: (){
                                navigateTo(context, const NotificationScreen());
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            IconButton(icon: const Icon(Icons.help_center),
                              iconSize: 50.0,
                              color: Colors.redAccent,
                              onPressed: (){
                                navigateTo(context, const NotificationScreen());
