        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children:  [
                  const Icon(Icons.my_location_outlined, color: Colors.redAccent,),
              ...
              myDivider(),
              const Text('Tell us more about your shipment',),
              const SizedBox(height: 15.0,),
              const Text('Dimension : Kg', style: TextStyle(color: Colors.grey),),
              defaultTextForm(
              ...
              const SizedBox(height: 15.0,),
              const Text('No.of Package',style: TextStyle(color: Colors.grey),),
              defaultTextForm(
              ...
              const SizedBox(height: 15.0,),
              const Text('Ship Date',style: TextStyle(color: Colors.grey),),
              defaultTextForm(
                  controller: shipDate,
                  type: TextInputType.text,
                  text: 'date',
